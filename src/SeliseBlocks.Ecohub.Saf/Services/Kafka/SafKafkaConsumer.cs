...
public class SafKafkaConsumer
{
    ...
    public SafKafkaConsumer(string bootstrapServers, string topic, string groupId)
    {
    ...
    // TODO: Put this method in a common place from where both Kafka producer and consumer can access
